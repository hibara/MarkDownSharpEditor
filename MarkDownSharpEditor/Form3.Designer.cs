namespace MarkDownSharpEditor
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cmdCancel.Location = new System.Drawing.Point(357, 13);
			this.cmdCancel.Name = "cmdCancel";
			this.cmdCancel.Size = new System.Drawing.Size(92, 24);
			this.cmdCancel.TabIndex = 2;
			this.cmdCancel.Text = "キャンセル(&C)";
			...
			this.cmdApply.Location = new System.Drawing.Point(259, 13);
			this.cmdApply.Name = "cmdApply";
			this.cmdApply.Size = new System.Drawing.Size(93, 24);
			this.cmdApply.TabIndex = 1;
			this.cmdApply.Text = "適用(&A)";
			...
			this.cmdOK.Location = new System.Drawing.Point(161, 13);
			...
			this.tabControl1.Size = new System.Drawing.Size(440, 427);
			...
			this.label2.Text = "※この設定に関してだけはレジストリに設定を書き込みます。";
			// 
			// cmdUnAssociateFiles
			// 
			this.cmdUnAssociateFiles.Location = new System.Drawing.Point(15, 53);
			this.cmdUnAssociateFiles.Name = "cmdUnAssociateFiles";
			this.cmdUnAssociateFiles.Size = new System.Drawing.Size(360, 23);
			this.cmdUnAssociateFiles.TabIndex = 1;
			this.cmdUnAssociateFiles.Text = "関連付け設定を解除する(&U)";
			...
			// cmdAssociateFiles
			// 
			this.cmdAssociateFiles.Location = new System.Drawing.Point(15, 21);
			...
			this.groupBox2.Size = new System.Drawing.Size(390, 187);
			this.groupBox2.TabIndex = 3;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "HTMLファイル出力表示設定：";
			// 
			// lblms
			// 
			this.lblms.AutoSize = true;
			this.lblms.Location = new System.Drawing.Point(294, 152);
			this.lblms.Name = "lblms";
			this.lblms.Size = new System.Drawing.Size(75, 12);
			this.lblms.TabIndex = 18;
			this.lblms.Text = "秒(カスタム値）";
            ...
            "30秒",
            "60秒"});
			this.comboPreviewInterval.Location = new System.Drawing.Point(167, 147);
			this.comboPreviewInterval.Name = "comboPreviewInterval";
			this.comboPreviewInterval.Size = new System.Drawing.Size(121, 20);
			this.comboPreviewInterval.TabIndex = 17;
			...
			// 
			this.lblPreviewIntervalCaption.AutoSize = true;
			this.lblPreviewIntervalCaption.Location = new System.Drawing.Point(13, 151);
			...
			// 
			this.checkBoxEditingHighlightColor.AutoSize = true;
			this.checkBoxEditingHighlightColor.Location = new System.Drawing.Point(15, 87);
			this.checkBoxEditingHighlightColor.Name = "checkBoxEditingHighlightColor";
			this.checkBoxEditingHighlightColor.Size = new System.Drawing.Size(221, 16);
			this.checkBoxEditingHighlightColor.TabIndex = 7;
			this.checkBoxEditingHighlightColor.Text = "編集部分をハイライトカラーで表示する(&V)";
			...
			// labelHtmlColorName
			// 
			this.labelHtmlColorName.AutoSize = true;
			this.labelHtmlColorName.Location = new System.Drawing.Point(169, 115);
			this.labelHtmlColorName.Name = "labelHtmlColorName";
			this.labelHtmlColorName.Size = new System.Drawing.Size(109, 12);
			this.labelHtmlColorName.TabIndex = 6;
			this.labelHtmlColorName.Text = "labelHtmlColorName";
			// 
			// labelHighLightColor
			// 
			...
			this.labelHighLightColor.Location = new System.Drawing.Point(15, 110);
			this.labelHighLightColor.Name = "labelHighLightColor";
			this.labelHighLightColor.Padding = new System.Windows.Forms.Padding(6, 4, 6, 4);
			this.labelHighLightColor.Size = new System.Drawing.Size(148, 22);
			this.labelHighLightColor.TabIndex = 5;
			this.labelHighLightColor.Text = "編集部分のハイライトカラー";
			this.labelHighLightColor.Click += new System.EventHandler(this.labelHighLightColor_Click);
			// 
			// checkBoxShowHtmlToClipboardMessage
			// 
			this.checkBoxShowHtmlToClipboardMessage.AutoSize = true;
			this.checkBoxShowHtmlToClipboardMessage.Location = new System.Drawing.Point(15, 58);
			this.checkBoxShowHtmlToClipboardMessage.Name = "checkBoxShowHtmlToClipboardMessage";
			this.checkBoxShowHtmlToClipboardMessage.Size = new System.Drawing.Size(360, 16);
			this.checkBoxShowHtmlToClipboardMessage.TabIndex = 4;
			this.checkBoxShowHtmlToClipboardMessage.Text = "HTMLソースをクリップボードコピーしたときに確認メッセージを表示する(&M)";
			...
			// 
			this.checkBoxOpenEditFileBefore.AutoSize = true;
			this.checkBoxOpenEditFileBefore.Location = new System.Drawing.Point(20, 28);
			this.checkBoxOpenEditFileBefore.Name = "checkBoxOpenEditFileBefore";
			this.checkBoxOpenEditFileBefore.Size = new System.Drawing.Size(262, 16);
			this.checkBoxOpenEditFileBefore.TabIndex = 0;
			this.checkBoxOpenEditFileBefore.Text = "前に編集していたファイルを起動時に自動で開く(&O)";
			...
			this.groupBox4.Controls.Add(this.labelBlockquotesBackColor);
			this.groupBox4.Controls.Add(this.labelBlockquotesForeColor);
			this.groupBox4.Controls.Add(this.labelBlockquotesColor);
			this.groupBox4.Controls.Add(this.labelCodeBlockBackColor);
			this.groupBox4.Controls.Add(this.labelCodeBlockForeColor);
			this.groupBox4.Controls.Add(this.labelCodeBlockColor);
			this.groupBox4.Controls.Add(this.labelCommentsBackColor);
			this.groupBox4.Controls.Add(this.labelCommentsForeColor);
			this.groupBox4.Controls.Add(this.labelHorizontalBackColor);
			this.groupBox4.Controls.Add(this.labelHorizontalForeColor);
			this.groupBox4.Controls.Add(this.labelCodeBackColor);
			this.groupBox4.Controls.Add(this.labelCodeForeColor);
			this.groupBox4.Controls.Add(this.labelListsBackColor);
			this.groupBox4.Controls.Add(this.labelListsForeColor);
			this.groupBox4.Controls.Add(this.labelEmphasisBackColor);
			this.groupBox4.Controls.Add(this.labelEmphasisForeColor);
			this.groupBox4.Controls.Add(this.labelLinksBackColor);
			this.groupBox4.Controls.Add(this.labelLinksForeColor);
			this.groupBox4.Controls.Add(this.labelImagesBackColor);
			this.groupBox4.Controls.Add(this.labelImagesForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine6BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine6ForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine5BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine5ForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine4BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine4ForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine3BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine3ForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine2BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine2ForeColor);
			this.groupBox4.Controls.Add(this.labelHeadLine1BackColor);
			this.groupBox4.Controls.Add(this.labelHeadLine1ForeColor);
			this.groupBox4.Controls.Add(this.labelLineBreakBackColor);
			this.groupBox4.Controls.Add(this.labelLineBreakForeColor);
			this.groupBox4.Controls.Add(this.labelCommentsColor);
			this.groupBox4.Controls.Add(this.labelImagesColor);
			this.groupBox4.Controls.Add(this.labelEmphasisColor);
			this.groupBox4.Controls.Add(this.labelHorizontalColor);
			this.groupBox4.Controls.Add(this.labelLinksColor);
			this.groupBox4.Controls.Add(this.labelCodeColor);
			this.groupBox4.Controls.Add(this.labelListsColor);
			this.groupBox4.Controls.Add(this.labelHeadLine6Color);
			this.groupBox4.Controls.Add(this.labelHeadLine5Color);
			this.groupBox4.Controls.Add(this.labelHeadLine4Color);
			this.groupBox4.Controls.Add(this.labelHeadLine3Color);
			this.groupBox4.Controls.Add(this.labelHeadLine2Color);
			this.groupBox4.Controls.Add(this.labelHeadLine1Color);
			...
			this.labelBlockquotesBackColor.TabIndex = 56;
			...
			this.labelBlockquotesForeColor.TabIndex = 55;
			...
			this.labelBlockquotesColor.TabIndex = 54;
			this.labelBlockquotesColor.Text = "引用";
			// 
			...
			this.labelCodeBlockBackColor.Location = new System.Drawing.Point(342, 217);
			this.labelCodeBlockBackColor.Name = "labelCodeBlockBackColor";
			this.labelCodeBlockBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeBlockBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelCodeBlockBackColor.TabIndex = 53;
			...
			this.labelCodeBlockForeColor.Location = new System.Drawing.Point(312, 217);
			this.labelCodeBlockForeColor.Name = "labelCodeBlockForeColor";
			this.labelCodeBlockForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeBlockForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelCodeBlockForeColor.TabIndex = 52;
			...
			this.labelCodeBlockColor.Location = new System.Drawing.Point(206, 217);
			this.labelCodeBlockColor.Name = "labelCodeBlockColor";
			this.labelCodeBlockColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeBlockColor.Size = new System.Drawing.Size(100, 22);
			this.labelCodeBlockColor.TabIndex = 51;
			this.labelCodeBlockColor.Text = "コードブロック";
			// 
			...
			this.labelCommentsBackColor.Location = new System.Drawing.Point(342, 289);
			this.labelCommentsBackColor.Name = "labelCommentsBackColor";
			this.labelCommentsBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCommentsBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelCommentsBackColor.TabIndex = 50;
			...
			this.labelCommentsForeColor.Location = new System.Drawing.Point(312, 289);
			this.labelCommentsForeColor.Name = "labelCommentsForeColor";
			this.labelCommentsForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCommentsForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelCommentsForeColor.TabIndex = 49;
			...
			this.labelHorizontalBackColor.Location = new System.Drawing.Point(342, 253);
			this.labelHorizontalBackColor.Name = "labelHorizontalBackColor";
			this.labelHorizontalBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelHorizontalBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelHorizontalBackColor.TabIndex = 48;
			...
			this.labelHorizontalForeColor.Location = new System.Drawing.Point(312, 253);
			this.labelHorizontalForeColor.Name = "labelHorizontalForeColor";
			this.labelHorizontalForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelHorizontalForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelHorizontalForeColor.TabIndex = 47;
			...
			this.labelCodeBackColor.Location = new System.Drawing.Point(342, 181);
			this.labelCodeBackColor.Name = "labelCodeBackColor";
			this.labelCodeBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelCodeBackColor.TabIndex = 46;
			...
			this.labelCodeForeColor.Location = new System.Drawing.Point(312, 181);
			this.labelCodeForeColor.Name = "labelCodeForeColor";
			this.labelCodeForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelCodeForeColor.TabIndex = 45;
			...
			this.labelListsBackColor.Location = new System.Drawing.Point(342, 145);
			this.labelListsBackColor.Name = "labelListsBackColor";
			this.labelListsBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelListsBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelListsBackColor.TabIndex = 44;
			...
			this.labelListsForeColor.Location = new System.Drawing.Point(312, 145);
			this.labelListsForeColor.Name = "labelListsForeColor";
			this.labelListsForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelListsForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelListsForeColor.TabIndex = 43;
			...
			this.labelEmphasisBackColor.Location = new System.Drawing.Point(342, 109);
			this.labelEmphasisBackColor.Name = "labelEmphasisBackColor";
			this.labelEmphasisBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelEmphasisBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelEmphasisBackColor.TabIndex = 42;
			...
			this.labelEmphasisForeColor.Location = new System.Drawing.Point(312, 109);
			this.labelEmphasisForeColor.Name = "labelEmphasisForeColor";
			this.labelEmphasisForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelEmphasisForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelEmphasisForeColor.TabIndex = 41;
			...
			this.labelLinksBackColor.Location = new System.Drawing.Point(342, 73);
			this.labelLinksBackColor.Name = "labelLinksBackColor";
			this.labelLinksBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelLinksBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelLinksBackColor.TabIndex = 40;
			...
			this.labelLinksForeColor.Location = new System.Drawing.Point(312, 73);
			this.labelLinksForeColor.Name = "labelLinksForeColor";
			this.labelLinksForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelLinksForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelLinksForeColor.TabIndex = 39;
			...
			this.labelImagesBackColor.Location = new System.Drawing.Point(342, 37);
			this.labelImagesBackColor.Name = "labelImagesBackColor";
			this.labelImagesBackColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelImagesBackColor.Size = new System.Drawing.Size(22, 22);
			this.labelImagesBackColor.TabIndex = 38;
			...
			this.labelImagesForeColor.Location = new System.Drawing.Point(312, 37);
			this.labelImagesForeColor.Name = "labelImagesForeColor";
			this.labelImagesForeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelImagesForeColor.Size = new System.Drawing.Size(22, 22);
			this.labelImagesForeColor.TabIndex = 37;
			...
			this.labelHeadLine6BackColor.TabIndex = 36;
			...
			this.labelHeadLine6ForeColor.TabIndex = 35;
			...
			this.labelHeadLine5BackColor.TabIndex = 34;
			...
			this.labelHeadLine5ForeColor.TabIndex = 33;
			...
			this.labelHeadLine4BackColor.TabIndex = 32;
			...
			this.labelHeadLine4ForeColor.TabIndex = 31;
			...
			this.labelHeadLine3BackColor.TabIndex = 30;
			...
			this.labelHeadLine3ForeColor.TabIndex = 29;
			...
			this.labelHeadLine2BackColor.TabIndex = 28;
			...
			this.labelHeadLine2ForeColor.TabIndex = 27;
			...
			this.labelHeadLine1BackColor.TabIndex = 26;
			...
			this.labelHeadLine1ForeColor.TabIndex = 25;
			...
			this.labelLineBreakBackColor.TabIndex = 24;
			...
			this.labelLineBreakForeColor.TabIndex = 23;
			...
			this.labelCommentsColor.Location = new System.Drawing.Point(206, 289);
			this.labelCommentsColor.Name = "labelCommentsColor";
			this.labelCommentsColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCommentsColor.Size = new System.Drawing.Size(100, 22);
			this.labelCommentsColor.TabIndex = 22;
			this.labelCommentsColor.Text = "コメント";
			// 
			// labelImagesColor
			// 
			...
			this.labelImagesColor.Location = new System.Drawing.Point(206, 37);
			this.labelImagesColor.Name = "labelImagesColor";
			this.labelImagesColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelImagesColor.Size = new System.Drawing.Size(100, 22);
			this.labelImagesColor.TabIndex = 21;
			this.labelImagesColor.Text = "画像";
			// 
			// labelEmphasisColor
			// 
			...
			this.labelEmphasisColor.Location = new System.Drawing.Point(206, 109);
			this.labelEmphasisColor.Name = "labelEmphasisColor";
			this.labelEmphasisColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelEmphasisColor.Size = new System.Drawing.Size(100, 22);
			this.labelEmphasisColor.TabIndex = 20;
			this.labelEmphasisColor.Text = "強調";
			// 
			...
			this.labelHorizontalColor.Location = new System.Drawing.Point(206, 253);
			this.labelHorizontalColor.Name = "labelHorizontalColor";
			this.labelHorizontalColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelHorizontalColor.Size = new System.Drawing.Size(100, 22);
			this.labelHorizontalColor.TabIndex = 19;
			this.labelHorizontalColor.Text = "罫線";
			// 
			// labelLinksColor
			// 
			...
			this.labelLinksColor.Location = new System.Drawing.Point(206, 73);
			this.labelLinksColor.Name = "labelLinksColor";
			this.labelLinksColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelLinksColor.Size = new System.Drawing.Size(100, 22);
			this.labelLinksColor.TabIndex = 18;
			this.labelLinksColor.Text = "リンク";
			// 
			// labelCodeColor
			// 
			...
			this.labelCodeColor.Location = new System.Drawing.Point(206, 181);
			this.labelCodeColor.Name = "labelCodeColor";
			this.labelCodeColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelCodeColor.Size = new System.Drawing.Size(100, 22);
			this.labelCodeColor.TabIndex = 17;
			this.labelCodeColor.Text = "コード";
			// 
			// labelListsColor
			// 
			...
			this.labelListsColor.Location = new System.Drawing.Point(206, 145);
			this.labelListsColor.Name = "labelListsColor";
			this.labelListsColor.Padding = new System.Windows.Forms.Padding(4);
			this.labelListsColor.Size = new System.Drawing.Size(100, 22);
			this.labelListsColor.TabIndex = 16;
			this.labelListsColor.Text = "リスト";
			// 
			// labelHeadLine6Color
			// 
			...
			this.labelHeadLine6Color.TabIndex = 14;
			this.labelHeadLine6Color.Text = "見出し６";
			// 
			// labelHeadLine5Color
			// 
			...
			this.labelHeadLine5Color.TabIndex = 13;
			this.labelHeadLine5Color.Text = "見出し５";
			// 
			// labelHeadLine4Color
			// 
			...
			this.labelHeadLine4Color.TabIndex = 12;
			this.labelHeadLine4Color.Text = "見出し４";
			// 
			// labelHeadLine3Color
			// 
			...
			this.labelHeadLine3Color.TabIndex = 11;
			this.labelHeadLine3Color.Text = "見出し３";
			// 
			// labelHeadLine2Color
			// 
			...
			this.labelHeadLine2Color.TabIndex = 10;
			this.labelHeadLine2Color.Text = "見出し２";
			// 
			// labelHeadLine1Color
			// 
			...
			this.labelHeadLine1Color.TabIndex = 9;
			this.labelHeadLine1Color.Text = "見出し１";
			// 
			// labelLineBreakColor
			// 
			...
			this.labelLineBreakColor.TabIndex = 8;
			this.labelLineBreakColor.Text = "強制的な改行";
			this.toolTip1.SetToolTip(this.labelLineBreakColor, "「行末の半角スペース×２」です。");
			// 
			// tabPageCSS
			// 
			...
			// cmdDownItem
			// 
			this.cmdDownItem.Image = ((System.Drawing.Image)(resources.GetObject("cmdDownItem.Image")));
			this.cmdDownItem.Location = new System.Drawing.Point(400, 89);
			...
			// cmdUpItem
			// 
			this.cmdUpItem.Image = ((System.Drawing.Image)(resources.GetObject("cmdUpItem.Image")));
			this.cmdUpItem.Location = new System.Drawing.Point(400, 59);
			...
			// cmdAddCssFolder
			// 
			this.cmdAddCssFolder.Image = ((System.Drawing.Image)(resources.GetObject("cmdAddCssFolder.Image")));
			this.cmdAddCssFolder.Location = new System.Drawing.Point(52, 370);
			this.cmdAddCssFolder.Name = "cmdAddCssFolder";
			this.cmdAddCssFolder.Size = new System.Drawing.Size(24, 24);
			this.cmdAddCssFolder.TabIndex = 14;
			this.toolTip1.SetToolTip(this.cmdAddCssFolder, "CSSファイルのあるフォルダを指定して一括でパスを登録します。");
			...
			// 
			this.lblDefaultCssFileName.AutoSize = true;
			this.lblDefaultCssFileName.Location = new System.Drawing.Point(20, 14);
			this.lblDefaultCssFileName.Name = "lblDefaultCssFileName";
			this.lblDefaultCssFileName.Size = new System.Drawing.Size(91, 12);
			this.lblDefaultCssFileName.TabIndex = 13;
			this.lblDefaultCssFileName.Text = "CSSファイルリスト：";
			// 
			// listViewCssFiles
			// 
			...
			this.listViewCssFiles.Location = new System.Drawing.Point(20, 35);
			this.listViewCssFiles.MultiSelect = false;
			this.listViewCssFiles.Name = "listViewCssFiles";
			this.listViewCssFiles.Size = new System.Drawing.Size(374, 329);
			this.listViewCssFiles.TabIndex = 12;
			...
			// cmdOpenCssDir
			// 
			this.cmdOpenCssDir.Image = ((System.Drawing.Image)(resources.GetObject("cmdOpenCssDir.Image")));
			this.cmdOpenCssDir.Location = new System.Drawing.Point(127, 370);
			this.cmdOpenCssDir.Name = "cmdOpenCssDir";
			this.cmdOpenCssDir.Size = new System.Drawing.Size(24, 24);
			this.cmdOpenCssDir.TabIndex = 11;
			this.toolTip1.SetToolTip(this.cmdOpenCssDir, "選択したファイルのフォルダをExplorerで開きます。");
			this.cmdOpenCssDir.UseVisualStyleBackColor = true;
			this.cmdOpenCssDir.Click += new System.EventHandler(this.cmdOpenCssDir_Click);
			// 
			// cmdDeleteCssItem
			// 
			this.cmdDeleteCssItem.Image = ((System.Drawing.Image)(resources.GetObject("cmdDeleteCssItem.Image")));
			this.cmdDeleteCssItem.Location = new System.Drawing.Point(97, 370);
			this.cmdDeleteCssItem.Name = "cmdDeleteCssItem";
			this.cmdDeleteCssItem.Size = new System.Drawing.Size(24, 24);
			this.cmdDeleteCssItem.TabIndex = 9;
			this.toolTip1.SetToolTip(this.cmdDeleteCssItem, "CSSファイルをリストから、またはごみ箱へ移動します。");
			...
			// cmdAddCssFile
			// 
			this.cmdAddCssFile.Image = ((System.Drawing.Image)(resources.GetObject("cmdAddCssFile.Image")));
			this.cmdAddCssFile.Location = new System.Drawing.Point(22, 370);
			this.cmdAddCssFile.Name = "cmdAddCssFile";
			this.cmdAddCssFile.Size = new System.Drawing.Size(24, 24);
			this.cmdAddCssFile.TabIndex = 7;
			this.toolTip1.SetToolTip(this.cmdAddCssFile, "CSSファイルパスを追加します。");
			...
			this.groupBox3.Size = new System.Drawing.Size(384, 188);
			this.groupBox3.TabIndex = 7;
			this.groupBox3.TabStop = false;
			this.groupBox3.Text = "HTMLヘッダ：";
			// 
			// groupBoxCssOption
			// 
			...
			this.groupBoxCssOption.Location = new System.Drawing.Point(15, 84);
			this.groupBoxCssOption.Name = "groupBoxCssOption";
			this.groupBoxCssOption.Size = new System.Drawing.Size(352, 86);
			this.groupBoxCssOption.TabIndex = 6;
			this.groupBoxCssOption.TabStop = false;
			this.groupBoxCssOption.Text = "CSSファイルの指定：";
			// 
			// radioButtonInsertLinkTag
			// 
			this.radioButtonInsertLinkTag.AutoSize = true;
			this.radioButtonInsertLinkTag.Location = new System.Drawing.Point(15, 51);
			this.radioButtonInsertLinkTag.Name = "radioButtonInsertLinkTag";
			this.radioButtonInsertLinkTag.Size = new System.Drawing.Size(160, 16);
			this.radioButtonInsertLinkTag.TabIndex = 3;
			this.radioButtonInsertLinkTag.TabStop = true;
			this.radioButtonInsertLinkTag.Text = "<LINK>タグとして挿入する(&K)";
			...
			// 
			this.radioButtonImportCssFile.AutoSize = true;
			this.radioButtonImportCssFile.Location = new System.Drawing.Point(15, 26);
			this.radioButtonImportCssFile.Name = "radioButtonImportCssFile";
			this.radioButtonImportCssFile.Size = new System.Drawing.Size(250, 16);
			this.radioButtonImportCssFile.TabIndex = 2;
			this.radioButtonImportCssFile.TabStop = true;
			this.radioButtonImportCssFile.Text = "CSSファイルの内容をHTMLファイルに埋め込む(&I)";
			...
			this.comboBoxHtmlHeader.Location = new System.Drawing.Point(15, 49);
			this.comboBoxHtmlHeader.Name = "comboBoxHtmlHeader";
			this.comboBoxHtmlHeader.Size = new System.Drawing.Size(354, 20);
			this.comboBoxHtmlHeader.TabIndex = 5;
			this.comboBoxHtmlHeader.SelectedIndexChanged += new System.EventHandler(this.comboBoxHtmlHeader_SelectedIndexChanged);
			// 
			// chkInsertHtmlHeader
			// 
			this.chkInsertHtmlHeader.AutoSize = true;
			this.chkInsertHtmlHeader.Location = new System.Drawing.Point(15, 27);
			this.chkInsertHtmlHeader.Name = "chkInsertHtmlHeader";
			this.chkInsertHtmlHeader.Size = new System.Drawing.Size(310, 16);
			this.chkInsertHtmlHeader.TabIndex = 4;
			this.chkInsertHtmlHeader.Text = "出力するHTMLファイルにヘッダ（DOCTYPE等）を挿入する(&D)";
			...
			this.groupBoxEncoding.Location = new System.Drawing.Point(20, 222);
			this.groupBoxEncoding.Name = "groupBoxEncoding";
			this.groupBoxEncoding.Size = new System.Drawing.Size(384, 142);
			this.groupBoxEncoding.TabIndex = 6;
			this.groupBoxEncoding.TabStop = false;
			this.groupBoxEncoding.Text = "エンコーディング：";
			// 
			// label1
			// 
			...
			this.comboBoxSelectEncoding.Location = new System.Drawing.Point(15, 71);
			this.comboBoxSelectEncoding.Name = "comboBoxSelectEncoding";
			this.comboBoxSelectEncoding.Size = new System.Drawing.Size(354, 20);
			this.comboBoxSelectEncoding.TabIndex = 2;
			// 
			// radioButtonChangeEncoding
			// 
			this.radioButtonChangeEncoding.AutoSize = true;
			this.radioButtonChangeEncoding.Location = new System.Drawing.Point(15, 49);
			...
			// 
			this.radioButtonDefaultEncoding.AutoSize = true;
			this.radioButtonDefaultEncoding.Location = new System.Drawing.Point(15, 27);
			this.radioButtonDefaultEncoding.Name = "radioButtonDefaultEncoding";
			this.radioButtonDefaultEncoding.Size = new System.Drawing.Size(208, 16);
			this.radioButtonDefaultEncoding.TabIndex = 0;
			this.radioButtonDefaultEncoding.TabStop = true;
			this.radioButtonDefaultEncoding.Text = "編集中のエンコーディングを使用する(&D)";
			...
			this.openFileDialog1.Filter = "CSSファイル(*css)|*css|すべてのファイル(**)|**;";
			this.openFileDialog1.Title = "CSSファイルを開く";
			// 
			// saveFileDialog1
			// 
			this.saveFileDialog1.DefaultExt = "css";
			this.saveFileDialog1.Filter = "CSSファイル(*css)|*css|すべてのファイル(**)|**;";
			this.saveFileDialog1.Title = "ビルトインCSSファイルのエクスポート";
			// 
			// folderBrowserDialog1
			// 
			this.folderBrowserDialog1.Description = "ビルトインCSSファイルの場所を選択してください。";
			// 
			// fontDialog1
			// 
